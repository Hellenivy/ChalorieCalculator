...
def fooditem(request):
    ...
    return render(request,'fooditem.html',{'context': context})
...
def createfooditem(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('/')
    context={'form':form}
    return render(request,'createfooditem.html',{'context': context})
...
def userPage(request):
    ...
    return render(request,'user',{'context': context})
...
def addFooditem(request):
    ...
    context={'form':form}
    return render(request,'addUserFooditem.html',{'context': context})